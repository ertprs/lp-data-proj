...
export class DataHistoryController {
    ...
    async getEngHistoryData(@Param() params, @Body() body: {params, payload: EngagementHistoryBody}): Promise<any> {
    ...
    async getMsgInteractionsData(@Param() params, @Body() body: {params, payload: MsgInteractionBody}): Promise<any> {
        const {bearer, accountId} = params;
        console.log('params: ', params)
        console.log(bearer, accountId)
